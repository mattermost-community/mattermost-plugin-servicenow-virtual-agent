...
// Source: github.com/Brightscout/mattermost-plugin-servicenow-virtual-agent/server/plugin (interfaces: Client)
...
func (m *MockClient) SendMessageToVirtualAgentAPI(arg0, arg1 string, arg2 bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMessageToVirtualAgentAPI", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockClientMockRecorder) SendMessageToVirtualAgentAPI(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMessageToVirtualAgentAPI", reflect.TypeOf((*MockClient)(nil).SendMessageToVirtualAgentAPI), arg0, arg1, arg2)
}
