...
// LoadPostIDs mocks base method.
func (m *MockStore) LoadPostIDs(arg0 string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadPostIDs", arg0)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// LoadPostIDs indicates an expected call of LoadPostIDs.
func (mr *MockStoreMockRecorder) LoadPostIDs(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadPostIDs", reflect.TypeOf((*MockStore)(nil).LoadPostIDs), arg0)
}
...
// StorePostIDs mocks base method.
func (m *MockStore) StorePostIDs(arg0 string, arg1 []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorePostIDs", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// StorePostIDs indicates an expected call of StorePostIDs.
func (mr *MockStoreMockRecorder) StorePostIDs(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorePostIDs", reflect.TypeOf((*MockStore)(nil).StorePostIDs), arg0, arg1)
}
